...
"use strict";
var _store = __webpack_require__(331);var _store2 = _interopRequireDefault(_store);
var _viewController = __webpack_require__(332);var _viewController2 = _interopRequireDefault(_viewController);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();var _apiDecorator = __webpack_require__(333);var _apiDecorator2 = _interopRequireDefault(_apiDecorator);
    ...
    function ViewController(store) {_classCallCheck(this, ViewController);
        ...
        {var _this = this;
            ...
            [].concat(_toConsumableArray(actionHolders)).forEach(function (holder) {
                ...
                holder.addEventListener(event, function () {
                    ...
                    if (source) {
                        _this.store.dispatch({ type: actionType, source: source });
                    } else {
                        _this.store.dispatch({ type: actionType });
                    }
                });
            });
        ...
        {var _this2 = this;
            ...
            if (state.appIsRunning && !state.channels) {
                var runAppCode = function runAppCode(event) {return __webpack_require__.e/* require.ensure */(0).then((function (require) {return __webpack_require__(346).default(_this2.store);}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
            ...
            if (!state.currentChannel) {
                ...
                then(function (data) {
                    _this2.store.dispatch({ type: "GET_NEWS_SUCCESS", articles: data });
                });
            }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();var _toggleContainer = __webpack_require__(338);var _toggleContainer2 = _interopRequireDefault(_toggleContainer);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self, call) {if (!self) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call && (typeof call === "object" || typeof call === "function") ? call : self;}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } });if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass;}var
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getAppTemplate = undefined;var _article = __webpack_require__(341);

function getAppTemplate(state) {
    return '\n    <div class="page-wrapper">\n        <div id="root" class="root">\n            <header class="' + (


    state.appIsRunning ? '' : 'app-off ') + ' app-header">\n                <div class="header-logo">\n                    News\n                </div>\n            </header>\n            <button id="run-app-button" class="' + (




    state.appIsRunning ? '' : 'app-off ') + ' run-app-button" data-action="click: RUN_APP">Run App</button>\n            <div id="channels-list-container" class="channels-list-container">\n            ' + (

    state.channels ? '<ul>\n                    ' +

    state.channels.reduce(function (markup, channel) {return markup + ('<li><button data-action="click: GET_NEWS" data-source="' + channel.source + '">' + channel.title + '</button></li>');}, '') + '\n                </ul>' : '') + '\n            </div>\n            ' + (




    state.appIsRunning ? '<div>\n                <button class="choose-channel-button" data-toggle-target="channels-list-container">Choose channel</button>\n            </div>' : '') + '\n            ' + (



    state.articles ? '<div id="news-container" class="news-container">\n                    ' +

    (0, _article.renderArticles)(state.articles) + '\n                </div>' : '') + '\n            </div>\n            <footer class="page-footer">\n                <p>\n                    &copy; Powered by\n                    <a href="https://newsapi.org" target="_blank">NewsAPI.org</a>\n                </p>\n            </footer>\n    </div>';
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });function renderArticles(articles) {
    var result = "";
    ...
    {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : article,urlToImage = _ref.urlToImage,url = _ref.url,title = _ref.title,publishedAt = _ref.publishedAt,author = _ref.author,description = _ref.description;
