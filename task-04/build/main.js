...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducer_js__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_app_off_scss__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_app_off_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__styles_app_off_scss__);
...
let reducer = Object(__WEBPACK_IMPORTED_MODULE_1__reducer_js__["a" /* newsApp */])(initialState);
let store = new __WEBPACK_IMPORTED_MODULE_0__store_js__["a" /* default */](reducer);
    ...
    setNextState(actionResult) {
        switch (actionResult.actionType) {
            case 'run-app': {
                ...
                let runAppCode = event => __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 333)).then(module => {
...
const newsApp = (state = initialState, action) => {
    switch (action.type) {
        case 'RUN_APP': {
            return state.appIsRunning = true;
        }
        default: {
            return state;
        }
